...
```bash
# 1. Clone repository
git clone https://github.com/SparklingSynapse/AriaType.git
cd AriaType
...
| `docs/` | All documentation (progressive disclosure) | Understanding architecture, conventions, specs |
...
AGENTS.md                    # Execution constraints and verification rules
    ↓
docs/README.md               # Documentation map and canonical source routing
    ↓
docs/architecture/decisions/ # Architectural rationale and major decisions
docs/architecture/           # System architecture, layers, data flow
docs/spec/                   # Contracts, testing, logging, API boundaries
docs/conventions/            # Coding conventions, design system
docs/guides/                 # Debugging, adding providers
docs/feat/<name>/<ver>/      # Feature specifications (source of truth)
```

**Reading order for new contributors**:

1. [`AGENTS.md`](../../AGENTS.md) — execution constraints, verification commands, and default iteration strategy
2. [`docs/README.md`](../README.md) — document roles and canonical source routing
3. [`docs/architecture/decisions/README.md`](../architecture/decisions/README.md) — architectural rationale and major decisions
4. [`docs/spec/`](../spec/) and [`docs/architecture/data-flow.md`](../architecture/data-flow.md) — contracts, invariants, and the primary workflow
5. [`docs/architecture/README.md`](../architecture/README.md) — system map and package boundaries
...
1. **Find the spec** — Features driven by `docs/feat/<name>/<version>/prd/erd.md`
...
| Task | Where to Start |
|------|----------------|
| Add a new STT provider | [`apps/desktop/src-tauri/CONTRIBUTING.md`](../../apps/desktop/src-tauri/CONTRIBUTING.md) + [`docs/guides/adding-stt-provider.md`](./adding-stt-provider.md) |
...
| Debug production issue | [`docs/guides/debugging.md`](./debugging.md) — log locations, crash reports |
| Understand logging requirements | [`docs/spec/logs.md`](../spec/logs.md) — structured fields, lowercase messages |
...
| Documentation entry points and canonical indexes | [`docs/README.md`](../README.md) |
| Architecture layers | [`docs/architecture/layers.md`](../architecture/layers.md) |
| Data flow and state machines | [`docs/architecture/data-flow.md`](../architecture/data-flow.md) |
| Testing and coverage | [`docs/spec/testing.md`](../spec/testing.md) |
| Logging standard | [`docs/spec/logs.md`](../spec/logs.md) |
| STT engine architecture | [`apps/desktop/src-tauri/CONTRIBUTING.md`](../../apps/desktop/src-tauri/CONTRIBUTING.md) |
| Debug guide | [`docs/guides/debugging.md`](./debugging.md) |
