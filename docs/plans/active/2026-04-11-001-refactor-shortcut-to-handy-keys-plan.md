...
- R3. Shortcut logic must be in a dedicated module following `docs/architecture/layers.md` layer rules
...
- Update `docs/reference/providers/stt.md` if shortcut affects recording trigger docs
...
- ADR-004 recording pipeline pattern: `docs/architecture/decisions/004-*.md`
