...
> [!TIP]
> **v0.4 の新機能 (2026-04-25)**
> - **Riffモード** – 自由に話して、AIが自然な文章に整える
> - **3つのホットキーモード** – Dictate（原文）、Riff（整形）、Custom（カスタム）
> - **プロファイル別テンプレート** – 各ショートカットに独自の整形スタイルを設定
...
- 🎙 **2つのショートカット** – `Cmd+/` で聴写（原文）、`Opt+/` で自動整形
