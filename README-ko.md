...
> [!TIP]
> **v0.3 새로운 기능**
> - **실패한 전사 재시도** – 저장된 음성으로 실패한 항목 재시도 가능
> - **ESC로 녹음 취소** – 녹음 중 ESC로 취소, 잘못된 항목 생성 방지
> - **긴 녹음 안정성 향상** – 긴 세션 잘림 문제 수정
> - **Fn키 지원** – 커스텀 단축키에서 Fn키 조합 지원
...
- 🎙 **전역 단축키** – `Shift+Space` 누르고 말하고 떼면, 모든 앱에 텍스트 입력
